            ...
            <div className="flex flex-col justify-center  p-4 rounded-tr-3xl  shadow-[0_0_10px_0_rgba(0,0,0,0.5)] ">
                ...
                <form action="">
                    ...
                    <div className="w-full ">
                        <textarea style={{ fontFamily: forumFont.style.fontFamily }} className="w-full bg-[#523E27] h-32 px-3 py-2 border rounded-lg placeholder:text-[#f1ebd1] 
                        focus:outline-none text-[#f1ebd1] " placeholder="contoh: Selamat untuk acara nya"></textarea>
                    </div>
